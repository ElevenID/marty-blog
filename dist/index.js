...
const me = Z({
  "aiko-tanaka": {
    ...
    worldview: "Aiko sees standards as the real pressure field around identity. Teams that ignore standards and regulatory direction eventually pay in rework, interoperability failures, or market exclusion.",
  ...
  "marcus-vale": {
    ...
    worldview: "Marcus assumes any identity claim is only as strong as its trust anchors, validation rules, revocation model, and algorithm choices. He does not distrust protocols; he distrusts hand-waving.",
  ...
  "elena-kovacs": {
    ...
    worldview: "Elena sees identity systems as governance systems disguised as software. Her default instinct is to make policy, approval, and compliance logic visible, versioned, and auditable.",
  ...
  "daniel-ortega": {
    ...
    worldview: "Daniel believes identity remains stuck because too much essential logic is trapped in proprietary platforms, one-off integrations, and application code. He treats protocols as the path from repeated custom work to reusable infrastructure.",
  ...
  "sofia-rahman": {
    ...
    worldview: "Sofia believes the truth of an identity system shows up at runtime: network loss, device security, holder experience, latency, and the physical environment where verification occurs.",
  ...
  "victor-leclerc": {
    ...
    worldview: "Victor believes the real promise of verifiable identity appears only when trust extends beyond a single issuer or deployment. He sees registries, federation, and issuer discovery as the infrastructure that makes ecosystems legible at scale.",
  ...
  "nora-patel": {
    ...
    worldview: "Nora treats over-disclosure as both a design failure and a governance failure. She believes privacy should be enforced by protocol shape, not by hoping verifiers behave well.",
...
principal.department == "HR"
  ...
  // ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ Chapter 1: Foundations ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  {
    ...
    order: 1,
    title: "What is Digital Identity?",
    summary: "Identity is the set of machine-readable claims about an entity - cryptographically signed, holder-controlled, and verifiable without calling home.",
    readTime: "6 min read",
  ...
  },
  {
    ...
    summary: "A Verifiable Credential is a cryptographically signed, holder-controlled document that proves something about its subject - without requiring the issuer to be online.",
    readTime: "7 min read",
  ...
  },
  {
    ...
    summary: "Verification is the process of confirming a credential is valid, was issued by a trusted authority, and belongs to the presenter - without calling home to the issuer.",
    readTime: "6 min read",
  ...
  },
  {
    ...
    summary: "Traditional IDV calls home on every check. Verifiable credentials embed the proof inside the credential - changing the architecture, the privacy model, and the business model.",
    readTime: "7 min read",
    conceptTags: ["foundation", "identity"],
    content: [
      {
...
Verifiable Credentials:
  ...
  // ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ Chapter 2: Core Objects ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  {
    ...
    summary: "A Trust Profile is the first MIP primitive. It answers: who do you trust to issue credentials, how do you validate their signatures, and what algorithm agility rules apply?",
    readTime: "8 min read",
  ...
  },
  {
    ...
    summary: "Credential Templates define what gets issued: the schema, claims map, validity rules, and selective disclosure configuration that governs every credential type in your system.",
    readTime: "8 min read",
  ...
  },
  {
    ...
    summary: "Presentation Policies define what a verifier needs to see - and nothing more. They encode minimum disclosure requirements as machine-readable configuration, not hardcoded logic.",
    readTime: "7 min read",
  ...
  },
  {
    ...
    summary: "Deployment Profiles are the fourth MIP primitive. They specify how verification runs in a real environment: online, offline, or hybrid, what cache TTLs apply, and how trust updates are delivered.",
    readTime: "7 min read",
  ...
  // ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ Chapter 3: Trust & Governance ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  {
    ...
    summary: "A trust anchor is the root of your trust chain. Understanding X.509 roots, CSCA certificates, and DID documents is essential to configuring Trust Profiles correctly.",
    readTime: "8 min read",
...
"trust_anchor": {
  ...
  },
  {
    ...
    summary: "Public key infrastructure is the cryptographic backbone of verifiable credentials. Learn how certificate chains work and why they matter for real-world MIP deployments.",
    readTime: "7 min read",
  ...
  },
  {
    ...
    summary: "MIP uses AWS Cedar for authorization decisions. Cedar policies are deny-by-default, human-readable, and designed to be auditable - not just by engineers, but by compliance teams.",
    readTime: "9 min read",
...
permit(
  ...
  },
  {
    ...
    summary: "A trust registry is the authoritative list of who is permitted to issue which credentials. Learn how MIP models trust registries and integrates them with Trust Profiles.",
    readTime: "7 min read",
  ...
  },
  {
    ...
    summary: "Privacy is a design constraint, not a feature flag. MIP's architecture enforces data minimization at every layer - from Credential Templates to Presentation Policies.",
    readTime: "7 min read",
  ...
  },
  {
    ...
    summary: "Presentation is how a holder shares credentials with a verifier. OID4VP is MIP's standard protocol - with support for selective disclosure, ZK predicates, and both same-device and cross-device flows.",
    readTime: "7 min read",
  ...
  },
  {
    ...
    order: 3,
    title: "Revocation",
    summary: "Credentials must be revocable before they expire. MIP supports five standardized revocation methods, each with different privacy, latency, and offline trade-offs.",
    readTime: "7 min read",
  ...
  },
  {
    ...
    order: 4,
    title: "Selective Disclosure",
    summary: "Selective disclosure lets a holder share only the claims a verifier needs - without leaking the rest. SD-JWT and zero-knowledge predicates are the two primary mechanisms in MIP.",
    readTime: "8 min read",
...
// Verifier cannot infer or reconstruct them`
  ...
  // ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ Chapter 5: Deployments ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  {
    ...
    order: 1,
    title: "Deployment Profiles in Practice",
    summary: "From cloud API to air-gapped kiosk, Deployment Profiles let you run the same trust model in any environment. This guide covers the key configuration decisions.",
    readTime: "7 min read",
  ...
  },
  {
    ...
    summary: "Compliance Profiles map specific regulated standards (ICAO 9303, eIDAS 2.0, AAMVA) to MIP primitives - adopt entire credential ecosystems as code, not custom integrations.",
    readTime: "6 min read",
  ...
  },
  {
    ...
    summary: "From ticket purchase to gate scan - how MIP orchestrates passport verification, pre-boarding credential issuance, and offline gate verification.",
    readTime: "7 min read",
...
4. Gate -> Offline verification -> Board`
  ...
  },
  {
    ...
    summary: "Verify a customer is over 21 without ever seeing their name, birth date, or address. Zero-knowledge predicates make privacy-preserving age checks practical.",
    readTime: "6 min read",
  ...
  },
  {
    ...
    summary: "Replace badge readers and LDAP lookups with verifiable employee credentials. Same identity for door access, VPN login, and application authorization.",
    readTime: "6 min read",
    conceptTags: ["deployment", "flow"],
    content: [
      {
  ...
  },
  {
    ...
    summary: "Gym memberships, professional associations, and conference badges - lightweight credential types that demonstrate MIP's flexibility beyond government identity.",
    readTime: "5 min read",
  ...
  },
  {
    ...
    summary: "Digital wallets, post-quantum cryptography, and global interoperability - where verifiable identity is headed and how MIP is designed to evolve with it.",
    readTime: "6 min read",
  ...
  // ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ Chapter 6: Implementations ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  {
    ...
    summary: "OpenID for Verifiable Credential Issuance (OID4VCI) is the IETF standard for delivering credentials from issuer to wallet. Here's how MIP implements both the authorization code and pre-authorized code flows.",
    readTime: "9 min read",
...
// Response:
{
  ...
  },
  {
    ...
    summary: "OpenID for Verifiable Presentations (OID4VP) is the standard for presenting credentials to a verifier - supporting selective disclosure, ZK predicates, and both same-device and cross-device flows.",
    readTime: "8 min read",
  ...
  },
  {
    ...
    summary: "ISO 18013-5 defines the mDoc format for government credentials. CBOR-encoded, device-bound, and built for proximity - here's how mDocs work and how MIP supports them.",
    readTime: "8 min read",
        ...
        code: `// DeviceRequest from verifier specifying which elements to disclose
{
  ...
  },
  {
    ...
    summary: "Open Badges 3.0 aligns the education credential standard with W3C VCs. MIP adds trust governance to Open Badges - enabling verifier-side validation of issuing institutions.",
    readTime: "7 min read",
  ...
  },
  {
    ...
    summary: "ICAO's Digital Travel Credential (DTC) standard brings passport verification to smartphones. MIP's ICAO Compliance Profile supports Virtual DTC, cloud-attested DTC, and hardware-bound DTC variants.",
    readTime: "8 min read",
      ...
      children: [
        /* @__PURE__ */ e(
          o,
          {
            ...
            children: "The Identity Infrastructure Handbook"
          }
        ),
        /* @__PURE__ */ e(
          o,
          {
            ...
            children: "Learn the Marty Identity Protocol"
          }
        ),
        /* @__PURE__ */ e(
          o,
  ...
  return /* @__PURE__ */ n(l, { sx: { mb: 2 }, children: [
    /* @__PURE__ */ e(
      o,
      {
        ...
        children: "Identity Infrastructure Map"
      }
    ),
    /* @__PURE__ */ e(
      o,
      {
        ...
        children: "The System at a Glance"
      }
    ),
    /* @__PURE__ */ e(
      o,
      {
        ...
        children: "Six reader-facing layers organize the handbook from foundations to governance. The five protocol primitives live inside the Protocol Model layer."
      }
    ),
    /* @__PURE__ */ e(
      l,
            ...
            children: /* @__PURE__ */ e(
              Rt,
              {
                ...
                primaryTypographyProps: {
                  ...
                  color: a ? "primary.main" : "text.primary",
      ...
      children: [
        ...
        /* @__PURE__ */ e(
          l,
          {
            ...
            children: /* @__PURE__ */ e("code", { children: t.code })
          }
        )
      ]
    }
        ...
        children: [
          ...
          /* @__PURE__ */ e(
            o,
            {
              ...
              gutterBottom: !0,
              sx: { fontSize: { xs: "2rem", md: "3rem" }, lineHeight: 1.15, letterSpacing: "-0.02em" },
              children: "Verifiable Identity Foundations"
            }
          ),
          /* @__PURE__ */ e(
            o,
          ...
          l,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ e(
                T,
                {
                  label: `${s.slugs.length} articles | ~${h} min`,
                  size: "small",
                  variant: "outlined",
