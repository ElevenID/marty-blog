...
const RAW_BLOG_POSTS = [
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'paragraph', text: 'At the schema level, a MIP Presentation Policy can require holder binding and name `NONCE`, `DEVICE_KEY`, or `SESSION_BINDING` methods. It can also state that a nonce is required. These fields make the verifier requirement reviewable before a flow runs.' },
